...
import OPUS from "../../src/images/OPUS.png"
    ...
    >
      ...
      <div className="sidebar__items">
        <div className="sidebar__logo dark:text-white">
          <h3 style={{width: 180}}>
          <img src={OPUS} style={{width: 30, height: 30, marginRight: 10, display: "inline-block"}}></img><span style={{ color: "#f7c522" }}>C</span>anopus
          </h3>
        </div>
        ...
        >
          ...
          />
          <div className={`${isStake && "dark:text-white"}`}>Stake</div>
        </Link>
      </div>
